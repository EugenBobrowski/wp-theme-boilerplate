...
<h3><?php _e( 'Reset your password?', 'atf' ); ?></h3>
...
<form action="<?php echo uf_get_action_url( 'reset_password' ); ?>" method="post">
	...
	<p>
		<?php _e( 'Please enter your username, your key and your new password.', 'atf' ) ?>
	</p>
	<p>
	...
	<p>
		<label for="user_key"><?php _e( 'Key:', 'atf' ); ?></label>
	...
	<p>
		<label for="pass1"><?php _e( 'Confirm Password', 'atf' ); ?></label>
