...
<form action="<?php echo uf_get_action_url( 'login' ); ?>" method="post">
	...
	<p>
		<label for="user_login"><?php _e( 'Username', 'atf' ); ?></label>
		<input type="text" name="user_login" id="user_login">
	</p>
	<p>
		<label for="user_pass"><?php _e( 'Password', 'atf' ); ?></label>
		<input type="password" name="user_pass" id="user_pass">
	</p>
	<?php echo apply_filters( 'login_form_middle', '', uf_login_form_args() ); ?>
	<p>
		<label for="rememberme"><input type="checkbox" name="rememberme" id="rememberme"> <?php _e( 'Remember', 'atf' ); ?></label>
		<input type="submit" name="submit" id="submit" value="<?php _e( 'Submit', 'atf' ); ?>">
	</p>
	<p>
		<a href="<?php echo home_url( '/user-forgot-password/' ); ?>"><?php _e( 'Forgot Password?', 'atf' ); ?></a> |
		<a href="<?php echo home_url( '/user-register/' ); ?>"><?php _e( 'Register', 'atf' ); ?></a>
	</p>
