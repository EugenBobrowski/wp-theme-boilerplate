...
function uf_register_messages( $message ) {
	...
	switch ( $message ) {
		...
		case 'illegal_names':
			?><div class="error"><p><?php _e( 'Invalid Username.', 'atf' ); ?></p></div><?php
			break;
		case 'username_exists':
			?><div class="error"><p><?php _e( 'This username exists.', 'atf' ); ?></p></div><?php
			break;
		case 'empty_email':
		case 'user_email':
		case 'invalid_email':
			?><div class="error"><p><?php _e( 'Invalid E-Mail address.', 'atf' ); ?></p></div><?php
			break;
		case 'email_exists':
		case 'user_email_used':
			?><div class="error"><p><?php _e( 'E-Mail exists.', 'atf' ); ?></p></div><?php
			break;
		case 'registerfail':
			?><div class="error"><p><?php _e( 'Something went wrong. Please consult the administrator.', 'atf' ); ?></p></div><?php
			break;
		default:
			break;
	}
