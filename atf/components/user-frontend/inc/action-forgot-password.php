...
function uf_forgot_password_messages( $message ) {
	switch ( $message ) {
		case 'confirmationsend':
			?><div class="updated"><p><?php _e( 'Check your e-mail for the confirmation link.', 'atf' ); ?></p></div><?php
			break;
		case 'empty_username':
			?><div class="error"><p><?php _e( 'Please enter something.', 'atf' ); ?></p></div><?php
			break;
		case 'invalid_email':
			?><div class="error"><p><?php _e( 'The E-Mail address is not valid.', 'atf' ); ?></p></div><?php
			break;
		case 'invalidcombo':
			?><div class="error"><p><?php _e( 'Your input doesn\'t match anything.', 'atf' ); ?></p></div><?php
			break;
		case 'no_password_reset':
			?><div class="error"><p><?php _e( 'This action is not allowed.', 'atf' ); ?></p></div><?php
			break;
		default:
			break;
	}
